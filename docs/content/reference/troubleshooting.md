...
Most of these come down to network reality or how scryfall serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

scryfall rate-limits like any public site. scryfall already paces
...
Where a surface is gated, scryfall reads a cookie or token you supply
...
`scryfall`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what scryfall actually did
