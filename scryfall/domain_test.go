...
func TestHostWiring(t *testing.T) {
	...
	if want := "scryfall://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("scryfall", "about")
	if err != nil || got.String() != "scryfall://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want scryfall://page/about", got.String(), err)
	}
}
